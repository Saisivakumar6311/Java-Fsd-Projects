...
public class  Virtualkey{
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		System.out.println("Name        : S. Saisivakumar");
		System.out.println("Email       : saisivakumar@company.com");
		...
		lp : while(true)
		{
			...
			case 1: File file = new File("C:\\Assisted practice projects\\phase1project");
					...
					ip : while(true)
					{
						...
						case 1 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 ...
									 File fe = new File("C:\\Assisted practice projects\\phase1project"+name);
									 if(fe.exists())
									 {
									 ...
									 {
										 FileWriter fw = new FileWriter("C:\\Assisted practice projects\\phase1project"+name);
						...
						case 2 : System.out.println("\n---------------------------------------");
								 ...
								 File fd = new File("C:\\Assisted practice projects\\phase1project"+deletename);
								 if(fd.exists())
								 {
									 if(fd.delete())
								        {
						...
						case 3 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 File filesearch = new File("C:\\Assisted practice projects\\phase1project");
